  ...
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard :title="t('profile.rpmLimit')" :value="effectiveRpmDisplay" :icon="GaugeIcon" icon-variant="danger" />
...
const effectiveRpmDisplay = computed(() => {
  const userRpm = user.value?.rpm_limit ?? 0
  return userRpm > 0 ? String(userRpm) : t('profile.rpmUnlimited')
})
...
const GaugeIcon = { render: () => h('svg', { fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', 'stroke-width': '1.5' }, [h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M12 6v6l4 2m5-2a9 9 0 11-18 0 9 9 0 0118 0z' })]) }
