  ...
  admin: {
    ...
    users: {
      ...
      form: {
        ...
        selectStatus: '选择状态',
        rpmLimit: '每分钟请求数 (RPM)',
        rpmLimitPlaceholder: '0 表示不限制（使用系统默认值）',
        rpmLimitHint: '该用户每分钟最大请求数，0 = 不限制；仅在所用分组未设置 rpm_limit 时生效'
      },
      adjustBalance: '调整余额',
    ...
    groups: {
      ...
      form: {
        ...
        rpmLimitHint: '每个用户在本分组下每分钟最大请求数，0 = 不限制；若此处未设置，将回落到用户级 RPM 限制',
        exclusiveLabel: '专属分组',
    ...
    settings: {
      ...
      defaults: {
        ...
        defaultUserRpmLimitHint: '新用户默认每分钟最大请求数，0 = 不限制；仅在分组未设置 rpm_limit 时兜底生效',
